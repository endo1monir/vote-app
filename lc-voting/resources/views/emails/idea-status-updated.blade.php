...
{{--                            <img width="60" src="https://i.ibb.co/hL4XZp2/android-chrome-192x192.png" title="logo" alt="logo">--}}
                            <img width="60" src="{{asset('img/logo.svg')}}" title="logo" alt="logo">
                        </a>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <p
                                        ...
                                        <strong
                                            style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">the title </strong>{{$idea->title}}
                                        <strong
                                            style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">the status changed to</strong> {{$idea->status->name}}
                                    </p>
